...
if(BUILD_CLIENT)
	...
	if(FEATURE_RENDERER_GLES)
		...
		# Emscripten provides GLES2 via -s FULL_ES2=1 flag (set in ETLEmscripten.cmake)
	endif()
	...
	if(EMSCRIPTEN)
		# Emscripten provides SDL2 via -s USE_SDL=2 flag (set in ETLEmscripten.cmake)
		# No need to find or link SDL2 explicitly
	elseif(NOT BUNDLED_SDL)
	...
	# localization support forces SDL icons and keeps the dependency count down
...
if(BUILD_CLIENT OR BUILD_SERVER)
	...
	elseif(EMSCRIPTEN)
		target_sources(engine_libraries INTERFACE "${SRC}/qcommon/dl_main_web.c")
	elseif(ANDROID)
